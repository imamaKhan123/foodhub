...
export const MENU_DATA: MenuItem[] = [
  // 🍔 Burgers
  {
    ...
    basePrice: 4.99,
    addOns: [
      { id: 20101, name: 'Cheese', price: 0.7 },
      { id: 20102, name: 'Make it a Meal Deal', price: 2.49 }
    ]
  },
  {
    id: 202,
    ...
    basePrice: 6.49,
    addOns: [
      { id: 20201, name: 'Cheese', price: 0.7 },
      { id: 20202, name: 'Make it a Meal Deal', price: 2.49 }
    ]
  },
  {
    id: 203,
    ...
    basePrice: 3.99,
    addOns: [
      { id: 20301, name: 'Cheese', price: 0.7 },
      { id: 20302, name: 'Make it a Meal Deal', price: 2.49 }
    ]
  },
  {
    id: 204,
    ...
    basePrice: 4.49,
    addOns: [
      { id: 20401, name: 'Cheese', price: 0.7 },
      { id: 20402, name: 'Make it a Meal Deal', price: 2.49 }
    ]
  },
  {
    id: 205,
    ...
    basePrice: 4.49,
    addOns: [
      { id: 20501, name: 'Cheese', price: 0.7 },
      { id: 20502, name: 'Make it a Meal Deal', price: 2.49 }
    ]
  },
  ...
  // 🌯 Wraps
  {
    ...
    name: 'Crispy Chicken Wrap',
    description: 'Crispy fried chicken wrap with fresh salad',
    image: 'https://www.momables.com/wp-content/uploads/2024/03/Crispy-chicken-wrap_SQ-500x500.jpg',
    category: 'Wraps',
    basePrice: 4.49,
    addOns: [
      { id: 30101, name: 'Cheese', price: 0.7 },
      { id: 30102, name: 'Make it a Meal Deal', price: 2.49 }
    ]
  },
  {
    id: 302,
    ...
    basePrice: 5.49,
    addOns: [
      { id: 30201, name: 'Cheese', price: 0.7 },
      { id: 30202, name: 'Make it a Meal Deal', price: 2.49 }
    ]
  },
  {
    id: 303,
    name: 'Falafel Wrap',
    description: 'Crispy falafel wrap with salad and sauce',
    image: 'https://www.liveeatlearn.com/wp-content/uploads/2025/03/sheet-pan-freezer-falafel-11-500x375.jpg',
    category: 'Wraps',
    basePrice: 4.99,
    addOns: [
      { id: 30301, name: 'Cheese', price: 0.7 },
      { id: 30302, name: 'Make it a Meal Deal', price: 2.49 }
    ]
  },
  {
    id: 304,
    ...
    basePrice: 4.99,
    addOns: [
      { id: 30401, name: 'Cheese', price: 0.7 },
      { id: 30402, name: 'Make it a Meal Deal', price: 2.49 }
    ]
  },
  {
    id: 305,
    ...
    basePrice: 4.99,
    addOns: [
      { id: 30501, name: 'Cheese', price: 0.7 },
      { id: 30502, name: 'Make it a Meal Deal', price: 2.49 }
    ]
  },
  ...
  // 🍕 Pizzas
  {
    ...
    addOns: [
      { id: 40101, name: 'Extra Cheese', price: 2 },
      { id: 40102, name: 'Pepperoni', price: 2 },
      { id: 40103, name: 'Mushrooms', price: 2 },
      { id: 40104, name: 'Olives', price: 1.5 }
    ]
  },
  {
    id: 402,
    ...
    addOns: [
      { id: 40201, name: 'Extra Cheese', price: 2 },
      { id: 40202, name: 'Pepperoni', price: 2 },
      { id: 40203, name: 'Mushrooms', price: 2 },
      { id: 40204, name: 'Olives', price: 1.5 }
    ]
  },
  {
    id: 403,
    ...
    addOns: [
      { id: 40301, name: 'Extra Cheese', price: 2 },
      { id: 40302, name: 'Pepperoni', price: 2 },
      { id: 40303, name: 'Mushrooms', price: 2 },
      { id: 40304, name: 'Olives', price: 1.5 }
    ]
  },
  ...
  // 🍟 Sides
  {
    ...
    addOns: [
      { id: 50101, name: 'Cheese Dip', price: 0.99 },
      { id: 50102, name: 'Chilli Sauce', price: 0.5 }
    ]
  },
  {
    id: 502,
    ...
    addOns: [
      { id: 50201, name: 'Cheese Dip', price: 0.99 },
      { id: 50202, name: 'BBQ Sauce', price: 0.5 }
    ]
  },
